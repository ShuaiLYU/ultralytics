    ...
    for ci, cat in enumerate(cats, 1):
        ...
        if args.mode == "predict":
            ...
            for img, label, source in samples:
                ...
                invad_pred, n_invad, invad_hmap = run_prior_viz(m, img, "heatmap_reconstruct", **pkw, **infer)
